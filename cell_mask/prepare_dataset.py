...
def crop_dataset(input,output, width=256,height=256):
    ...
    path = r"E:\isl\data_set\cell_mask256"
        ...
        for j in range(num_patches_per_image):
            ...
            while(ok_crop == False):
                ...
                if ok and ok2:
                    ...
                    count += 1
                    prefix = "\\"+str(count)
                    image1_channel1_pil.save(path+prefix+r"_dic_1.tiff")
                    image2_channel1_pil.save(path+prefix+r"_dic_2.tiff")
                    image3_channel1_pil.save(path+prefix+r"_dic_3.tiff")
                    image2_pil.save(path+prefix+r"_cellmask.png")
                    ok_crop = True
